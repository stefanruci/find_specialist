...
try{  
const registeredUser=await createUserWithEmailAndPassword(this.auth,user.email,user.password);
...
photoUrl:'https://i.avatar/'+this.randomIntFromInterval(200,400),
};
