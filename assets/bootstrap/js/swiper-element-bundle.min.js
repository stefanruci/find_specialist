...
!(function () {
                ...
                (a = parseInt(
                    ...
                    t.centeredSlides
                        ...
                        r > e.slides.length - e.loopedSlides + i / 2
                            ? (e.loopFix(),
                                (r = b(f(s, `${l}[data-swiper-slide-index="${a}"]`)[0])),
                                n(() => {
                                    e.slideTo(r);
                                }))
                            : e.slideTo(r)
    ...
    const pe = [
        function (e) {
            ...
            function p(e) {
                ...
                if (
                    (r && g >= b
                        ? ((y -= b), a || (x += s.slidesGrid[0]))
                        : r && g < b && ((y = -b), a && (x += s.slidesGrid[0])),
                    ...
                    if (
                        ...
                        if ((e && e.classList.add(s.bulletActiveClass), s.dynamicBullets)) {
                            const e = a[o],
                                t = a[d];
                            for (let e = o; e <= d; e += 1)
                                a[e].classList.add(`${s.bulletActiveClass}-main`);
                            p(e, "prev"), p(t, "next");
                        }
                    }
                    if (s.dynamicBullets) {
        ...
        function (e) {
            ...
            function T() {
                ...
                a &&
                (a.querySelector(`.${t.params.scrollbar.dragClass}`),
        ...
        function (e) {
            ...
            const a = (e, s) => {
                    ...
                    let n = e.getAttribute("data-swiper-parallax-x"),
                        l = e.getAttribute("data-swiper-parallax-y.json");
                ...
                r = () => {
                    ...
                    f(
                        e,
                        "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y.json], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]"
                    ).forEach((e) => {
                        a(e, i);
                    }),
                        s.forEach((e, s) => {
                            ...
                            (n += Math.ceil(s / 2) - i * (r.length - 1)),
                                ...
                                e
                                    .querySelectorAll(
                                        "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y.json], [data-swiper-parallax-opacity], [data-swiper-parallax-scale], [data-swiper-parallax-rotate]"
                                    )
                                    .forEach((e) => {
                                        a(e, n);
                                    });
        ...
        function (e) {
            ...
            function x(e) {
                ...
                if (((l = !1), (d = !1), u.push(e), !(u.length < 2))) {
                    ...
                    m.imageEl && (m.imageEl.style.transitionDuration = "0ms"), (c = !0);
                }
            }
            ...
            function C(e) {
                ...
                let a, r, l, o, d, c, u, g, w, b, E, x, S, A, T, M, C, P;
                t.params.cssMode &&
                ((t.wrapperEl.style.overflow = "hidden"),
                ...
                1 === p && z && ((a = void 0), (r = void 0)),
                    ...
                    !e || (1 === p && z)
                        ...
                        : ((C = m.slideEl.offsetWidth),
                            ...
                            (E = w * s.scale),
                            (x = b * s.scale),
                            (S = Math.min(C / 2 - E / 2, 0)),
                            (A = Math.min(P / 2 - x / 2, 0)),
                            (T = -S),
                            (M = -A),
                            (u = d * s.scale),
                            (g = c * s.scale),
        ...
        function (e) {
            ...
            n("init", () => {
                ...
                Object.assign(a.autoplay, {start: x, stop: S, pause: A, resume: T});
        },
        function (e) {
            ...
            const a = (e, s, i) => {
                let a = t.isHorizontal()
                    ...
                    r = t.isHorizontal()
                        ? e.querySelector(".swiper-slide-shadow-right")
                        : e.querySelector(".swiper-slide-shadow-bottom");
                a || (a = de(0, e, t.isHorizontal() ? "left" : "top")),
            ...
            ce.forEach((t) => {
                ...
                [...e.attributes].forEach((e) => {
                    ...
                    if (t) {
                        ...
                        const a = fe(e.value);
                        s[t] && ge.includes(e.name)
                            ? (s[t].constructor !== Object && (s[t] = {}), (s[t].enabled = a))
                            : (s[t] = a);
                    }
                }),
                me(t, s),
    ...
    const Ee = (e, t) => {
        ...
        ((s = s || document.createElement("style")),
            (s.textContent = [be, t ? t.cssStyles() : ""].join("\n")),
                ...
                (this.swiper = new K(this, {
                    ...
                    onAny: function (t) {
                        for (
                            ...
                            i[a - 1] = arguments[a];
                        const r = new CustomEvent(t.toLowerCase(), {
                            detail: i,
                            bubbles: !0,
                            cancelable: !0,
                        });
    ...
    window.customElements.define("swiper-container", Se),
    window.customElements.get("swiper-slide") ||
    window.customElements.define("swiper-slide", Ae));
})();
